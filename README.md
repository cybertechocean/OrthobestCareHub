...
- Gen-Z-style storefront, including product search, filters, categories, cart, checkout, customer accounts, order tracking, WhatsApp CTA, responsive mobile design, and an administrative dashboard.
...
SITE\_NAME=Orthobest Care Hub

SITE\_DOMAIN=orthobestcarehub.co.ke

OLD\_DOMAIN=orthobestcarerehab.co.ke
...
&#x20;   import\_categories.py

&#x20;   migrate\_old\_urls.py
...
1\. Record it in `OLD\_SITE\_AUDIT.md`.
